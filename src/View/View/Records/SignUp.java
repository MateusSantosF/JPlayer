...
public class SignUp extends javax.swing.JFrame {
    ...
    private boolean validateFields(){
        ...
        return !(jTextFieldName.getText().isEmpty() ||
                ...
                jPasswordFieldPassword.getText().isEmpty() ||
                jPasswordFieldConfirmPassword.getText().isEmpty());
    ...
    private IUser createUser(){     
        return new User(jTextFieldName.getText(),jTextFieldLastName.getText(), jTextFieldEmail.getText(), jPasswordFieldPassword.getText());
    }
